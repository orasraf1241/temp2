...
public class MainTrain {
	...
	public static void main(String[] args) {
		...
		if(MyInterpreter.interpreter(test1)!=rand*5-(8+2))
		...
		if(MyInterpreter.interpreter(test2)!=rand+3)
		...
		if(MyInterpreter.interpreter(test3)!=rand*2)
		...
		if(MyInterpreter.interpreter(test4)!=sim.simX+sim.simY*sim.simZ)
		...
		if(MyInterpreter.interpreter(test5)!=rand+2*5)
